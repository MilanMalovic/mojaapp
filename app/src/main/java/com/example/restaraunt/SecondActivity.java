...
public class SecondActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.actyvity_second);
...
// Loads an URL into the WebView
        ...
        rbRating.setRating(MealProvider.getMealById(position).getRating());
        ...
        btnBuy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast toast = Toast.makeText(v.getContext(), "You've bought " + MealProvider.getMealById(position).getName() + "!", Toast.LENGTH_LONG);
                toast.show();
            }
        });
    }
